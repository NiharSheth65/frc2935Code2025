...
public class onePieceRobotRight extends SequentialCommandGroup {
  ...
  public onePieceRobotRight(DriveSubsystem drive, VisionSubsystem vision, ElevatorSubsystem elevator, ArmSubsystem arm, CoralIntakeSubsystem intake, String reefside, int targetId) {
    ...
    addCommands(
      ...
      new InstantCommand(() -> drive.adjustGyroToAngle(vision.getReefAngleForTag(targetId, reefside))), 

      new autoScoreSpecificCoral(drive, vision, elevator, arm, intake, reefside, targetId)
    );
  }
}
