...
//     addCommands(
//       new twoPieceRobotLeft(drive, vision, photon, elevator, arm, intake, reefside),
...
//       new OdometryCmd(drive, pathConstants.threePieceDepositRobotLeft),
//       new autoScoreCoral(drive, vision, elevator, arm, intake, "left", reefside) 
