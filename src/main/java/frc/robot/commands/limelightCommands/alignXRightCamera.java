...
public class alignXRightCamera extends Command {
  ...
  /** Creates a new ali
   * gnXLeftCamera. */
  public alignXRightCamera(DriveSubsystem drive, VisionSubsystem vision, int pipeline, boolean end, double targetOffsetx ,double tolerancex) {
  ...
  public void execute() {
    if(VISION_SUBSYSTEM.limelightRightTargetSeen()){
      ...
      measuredValuex = correctedTx(VISION_SUBSYSTEM.getRightTx()); 
